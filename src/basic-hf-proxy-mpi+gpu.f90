...
!  Basic Hartree-Fock Proxy Application,  MPI+GPU offload version 
...
!parameter  ( dtol= 1.0d-10, rcut= 1.0d-12 ) 
 ...
 implicit  none 
 include   'mpif.h'
 integer   natom,ngauss, i,j,ij,k,l,kl,lx,n,nn, task 
...
! Hartree-Fock calculations. Integrals are screened to avoid  
! small terms. 
...
!$OMP TARGET MAP(TO:nn,ngauss,geom,xpnt,coef,dens,schwarz) MAP(TOFROM:fock)
